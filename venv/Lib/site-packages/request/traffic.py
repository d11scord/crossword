...
class NotAjax(Module):
    verbose_name = _('Не Ajax')
    verbose_name_plural = _('Не Ajax')
...
class Error(Module):
    verbose_name = _('Ошибка')
    verbose_name_plural = _('Ошибки')
...
class Error404(Module):
    verbose_name = _('Ошибка 404')
    verbose_name_plural = _('Ошибки 404')
...
class UniqueVisit(Module):
    verbose_name = _('Уникальное посещение')
    verbose_name_plural = _('Уникальные посещения')
...
class UniqueVisitor(Module):
    verbose_name = _('Уникальный посетитель')
    verbose_name_plural = _('Уникальные посетители')
...
class UniqueUser(Module):
    verbose_name = _('Уникальный пользователь')
    verbose_name_plural = _('Уникальные пользователи')
